...
INSERT INTO "new_User" ("assumedCheckPerDay", "cardTextSize", "createdAt", "dailyNewWords", "email", "emailVerified", "fuzzIntervals", "id", "intervalModifier", "lapseModifier", "masteryThresholdDays", "name", "passwordHash", "preferredAlgorithm", "settings", "showReading", "studyTheme", "theme", "updatedAt") SELECT "assumedCheckPerDay", "cardTextSize", "createdAt", "dailyNewWords", "email", "emailVerified", "fuzzIntervals", "id", "intervalModifier", "lapseModifier", "masteryThresholdDays", "name", "passwordHash", "preferredAlgorithm", "settings", "showReading", "studyTheme", "theme", "updatedAt" FROM "User";
DROP TABLE "User";
