...
INSERT INTO "new_User" ("assumedCheckPerDay", "autoPlayPronunciation", "billingConsentAt", "cardTextSize", "createdAt", "dailyNewWords", "desiredRetention", "email", "emailVerified", "fuzzIntervals", "id", "intervalModifier", "lapseModifier", "masteryThresholdDays", "name", "passwordHash", "preferredAlgorithm", "settings", "showReading", "soundEffects", "stripeCustomerId", "studyTheme", "subscriptionStatus", "targetLanguageId", "theme", "trialEndsAt", "updatedAt") SELECT "assumedCheckPerDay", "autoPlayPronunciation", "billingConsentAt", "cardTextSize", "createdAt", "dailyNewWords", "desiredRetention", "email", "emailVerified", "fuzzIntervals", "id", "intervalModifier", "lapseModifier", "masteryThresholdDays", "name", "passwordHash", "preferredAlgorithm", "settings", "showReading", "soundEffects", "stripeCustomerId", "studyTheme", "subscriptionStatus", "targetLanguageId", "theme", "trialEndsAt", "updatedAt" FROM "User";
DROP TABLE "User";
