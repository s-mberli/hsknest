...
INSERT INTO "new_User" ("assumedCheckPerDay", "cardTextSize", "createdAt", "dailyNewWords", "desiredRetention", "email", "emailVerified", "fuzzIntervals", "id", "intervalModifier", "lapseModifier", "masteryThresholdDays", "name", "passwordHash", "preferredAlgorithm", "settings", "showReading", "soundEffects", "studyTheme", "targetLanguageId", "theme", "updatedAt") SELECT "assumedCheckPerDay", "cardTextSize", "createdAt", "dailyNewWords", "desiredRetention", "email", "emailVerified", "fuzzIntervals", "id", "intervalModifier", "lapseModifier", "masteryThresholdDays", "name", "passwordHash", "preferredAlgorithm", "settings", "showReading", "soundEffects", "studyTheme", "targetLanguageId", "theme", "updatedAt" FROM "User";
DROP TABLE "User";
